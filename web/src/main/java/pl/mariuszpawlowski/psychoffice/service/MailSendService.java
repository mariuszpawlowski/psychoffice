package pl.mariuszpawlowski.psychoffice.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;
import org.thymeleaf.context.Context;
import pl.mariuszpawlowski.psychoffice.component.mail.EmailHtmlSender;
...
public class MailSendService {
    ...
    public EmailStatus sendContactForm(String name, String email, String message) throws UnsupportedEncodingException {
        ...
        EmailStatus emailStatus = emailHtmlSender.send(sendTo, email, from, emailTitle, "email/contactForm", context);
